<div class="sidebar">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-flat" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview  {{ request()->is('admin/about-video') || request()->is('admin/about-video/*')
|| request()->is('admin/abouts') || request()->is('admin/abouts/*') || request()->is('admin/icon-messages') || request()->is('admin/register-block/*')
