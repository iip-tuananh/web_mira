...
!function (e, t) {
    ...
    var s, r, o = function (e) {
            ...
            if (!e) return 0;
            var t = window.getComputedStyle(e), i = t.transitionDuration, n = t.transitionDelay, s = Number.parseFloat(i),
            ...
            if (e.style && e.parentNode && e.parentNode.style) {
                var t = getComputedStyle(e), i = getComputedStyle(e.parentNode);
        ...
        }, w = "rtl" === document.documentElement.dir, _ = (s = {}, r = 1, {
            set: function (e, t, i) {
                void 0 === e.bsKey && (e.bsKey = {key: t, id: r}, r++), s[e.bsKey.id] = i
            }, get: function (e, t) {
    ...
    function z(e, t, i) {
        var n = "string" == typeof t, s = n ? i : t, r = e.replace(T, ""), o = I[r];
    ...
    function D(e, t, i, n, s) {
        if ("string" == typeof t && e) {
            i || (i = n, n = null);
            var r = z(t, i, n), o = r[0], a = r[1], l = r[2], d = A(e), c = d[l] || (d[l] = {}),
                u = P(c, a, o ? i : null);
            if (u) u.oneOff = u.oneOff && s; else {
                var p = O(a, t.replace(S, "")), h = o ? function (e, t, i) {
                    return function n(s) {
                        for (var r = e.querySelectorAll(t), o = s.target; o && o !== this; o = o.parentNode) for (var a = r.length; a--;) if (r[a] === o) return s.delegateTarget = o, n.oneOff && N.off(e, s.type, i), i.apply(o, [s]);
                        return null
                    }
                }(e, i, n) : function (e, t) {
                    return function i(n) {
                ...
                h.delegationSelector = o ? i : null, h.originalHandler = a, h.oneOff = s, h.uidEvent = p, c[p] = h, e.addEventListener(l, h, o)
            }
        }
    }
    ...
    var N = {
        on: function (e, t, i, n) {
            ...
            if ("string" == typeof t && e) {
                var s = z(t, i, n), r = s[0], o = s[1], a = s[2], l = a !== t, d = A(e), c = t.startsWith(".");
                if (void 0 === o) {
            ...
            var n, s = y(), r = t.replace(T, ""), o = t !== r, a = k.has(r), l = !0, d = !0, c = !1, u = null;
            return o && s && (n = s.Event(t, i), s(e).trigger(n), l = !n.isPropagationStopped(), d = !n.isImmediatePropagationStopped(), c = n.isDefaultPrevented()), a ? (u = document.createEvent("HTMLEvents")).initEvent(r, l, !0) : u = new CustomEvent(t, {
                bubbles: l,
                cancelable: !0
        ...
        return s.close = function (e) {
            var t = e ? this._getRootElement(e) : this._element, i = this._triggerCloseEvent(t);
    ...
    N.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', W.handleDismiss(new W)), b((function () {
        var e = y();
        if (e) {
            var t = e.fn[B];
            e.fn[B] = W.jQueryInterface, e.fn[B].Constructor = W, e.fn[B].noConflict = function () {
    ...
    N.on(document, "click.bs.button.data-api", '[data-bs-toggle="button"]', (function (e) {
        e.preventDefault();
        var t = e.target.closest('[data-bs-toggle="button"]'), i = x(t, "bs.button");
    ...
    var Y = {
    ...
    }, $ = "carousel", V = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, X = {
        ...
        wrap: "boolean",
        touch: "boolean"
    }, U = {TOUCH: "touch", PEN: "pen"}, Q = function (e) {
        function s(t, i) {
            var n;
        ...
        return r.next = function () {
            ...
            if (!(e > this._items.length - 1 || e < 0)) if (this._isSliding) N.one(this._element, "slid.bs.carousel", (function () {
                return t.to(e)
            })); else {
            ...
            var i = "next" === e, n = "prev" === e, s = this._getItemIndex(t), r = this._items.length - 1;
            ...
            var i = this._getItemIndex(e), n = this._getItemIndex(G.findOne(".active.carousel-item", this._element));
            return N.trigger(this._element, "slide.bs.carousel", {relatedTarget: e, direction: t, from: n, to: i})
            ...
            var i, n, s, r = this, o = G.findOne(".active.carousel-item", this._element), a = this._getItemIndex(o),
                l = t || o && this._getItemByDirection(e, o), d = this._getItemIndex(l), u = Boolean(this._interval);
            if ("next" === e ? (i = "carousel-item-start", n = "carousel-item-next", s = "left") : (i = "carousel-item-end", n = "carousel-item-prev", s = "right"), l && l.classList.contains("active")) this._isSliding = !1; else if (!this._triggerSlideEvent(l, s).defaultPrevented && o && l) {
                if (this._isSliding = !0, u && this.pause(), this._setActiveIndicatorElement(l), this._activeElement = l, this._element.classList.contains("slide")) {
                    ...
                    N.one(o, "transitionend", (function () {
                        l.classList.remove(i, n), l.classList.add("active"), o.classList.remove("active", n, i), r._isSliding = !1, setTimeout((function () {
                            N.trigger(r._element, "slid.bs.carousel", {relatedTarget: l, direction: s, from: a, to: d})
                        }), 0)
                    })), h(o, p)
                } else o.classList.remove("active"), l.classList.add("active"), this._isSliding = !1, N.trigger(this._element, "slid.bs.carousel", {
                    relatedTarget: l,
                    direction: s,
                    from: a,
                    to: d
            ...
            var n = x(e, "bs.carousel"), r = i({}, V, Y.getDataAttributes(e));
            "object" == typeof t && (r = i({}, r, t));
            var o = "string" == typeof t ? t : r.slide;
            if (n || (n = new s(e, r)), "number" == typeof t) n.to(t); else if ("string" == typeof o) {
    ...
    N.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", Q.dataApiClickHandler), N.on(window, "load.bs.carousel.data-api", (function () {
        for (var e = G.find('[data-bs-ride="carousel"]'), t = 0, i = e.length; t < i; t++) Q.carouselInterface(e[t], x(e[t], "bs.carousel"))
    })), b((function () {
        var e = y();
        if (e) {
            var t = e.fn[$];
            e.fn[$] = Q.jQueryInterface, e.fn[$].Constructor = Q, e.fn[$].noConflict = function () {
                return e.fn[$] = t, Q.jQueryInterface
            }
        }
    }));
    var K = "collapse", Z = {toggle: !0, parent: ""}, J = {toggle: "boolean", parent: "(string|element)"},
        ee = function (e) {
            function s(t, i) {
                var n;
                ...
                for (var s = G.find('[data-bs-toggle="collapse"]'), r = 0, o = s.length; r < o; r++) {
                    var a = s[r], d = l(a), c = G.find(d).filter((function (e) {
                        return e === t
                    }));
            ...
            return r.toggle = function () {
                ...
                if (!this._isTransitioning && !this._element.classList.contains("show")) {
                    ...
                    if (!N.trigger(this._element, "show.bs.collapse").defaultPrevented) {
                        t && t.forEach((function (e) {
                            n !== e && s.collapseInterface(e, "hide"), i || E(e, "bs.collapse", null)
                        }));
                        ...
                        var a = "scroll" + (o[0].toUpperCase() + o.slice(1)), l = c(this._element);
                        N.one(this._element, "transitionend", (function () {
                            e._element.classList.remove("collapsing"), e._element.classList.add("collapse", "show"), e._element.style[o] = "", e.setTransitioning(!1), N.trigger(e._element, "shown.bs.collapse")
                        })), h(this._element, l), this._element.style[o] = this._element[a] + "px"
                    }
                }
            }, r.hide = function () {
                var e = this;
                if (!this._isTransitioning && this._element.classList.contains("show") && !N.trigger(this._element, "hide.bs.collapse").defaultPrevented) {
                    ...
                    if (i > 0) for (var n = 0; n < i; n++) {
                        var s = this._triggerArray[n], r = d(s);
                ...
                var n = x(e, "bs.collapse"), r = i({}, Z, Y.getDataAttributes(e), "object" == typeof t && t ? t : {});
    ...
    N.on(document, "click.bs.collapse.data-api", '[data-bs-toggle="collapse"]', (function (e) {
        ...
        var t = Y.getDataAttributes(this), i = l(this);
    ...
    var te = "top", ie = "bottom", ne = "right", se = "left", re = [te, ie, ne, se], oe = re.reduce((function (e, t) {
    ...
    var he = {
        name: "applyStyles", enabled: !0, phase: "write", fn: function (e) {
            ...
            Object.keys(t.elements).forEach((function (e) {
                ...
                pe(s) && de(s) && (Object.assign(s.style, i), Object.keys(n).forEach((function (e) {
                    var t = n[e];
            ...
            return Object.assign(t.elements.popper.style, i.popper), t.elements.arrow && Object.assign(t.elements.arrow.style, i.arrow), function () {
                Object.keys(t.elements).forEach((function (e) {
                    var n = t.elements[e], s = t.attributes[e] || {},
                        r = Object.keys(t.styles.hasOwnProperty(e) ? t.styles[e] : i[e]).reduce((function (e, t) {
                            return e[t] = "", e
                        }), {});
                    pe(n) && de(n) && (Object.assign(n.style, r), Object.keys(s).forEach((function (e) {
                        n.removeAttribute(e)
                    })))
                }))
            }
    ...
    function Ee(e) {
        for (var t = ce(e), i = _e(e); i && ye(i) && "static" === ve(i).position;) i = _e(i);
        return i && "body" === de(i) && "static" === ve(i).position ? t : i || function (e) {
            for (var t = we(e); pe(t) && ["html", "body"].indexOf(de(t)) < 0;) {
                var i = ve(t);
    ...
    var Me = {
        name: "arrow", enabled: !0, phase: "main", fn: function (e) {
            var t, i = e.state, n = e.name, s = i.elements.arrow, r = i.modifiersData.popperOffsets,
                o = fe(i.placement), a = xe(o), l = [se, ne].indexOf(o) >= 0 ? "height" : "width";
            if (s && r) {
                var d = i.modifiersData[n + "#persistent"].padding, c = me(s), u = "y" === a ? te : se,
                    p = "y" === a ? ie : ne, h = i.rects.reference[l] + i.rects.reference[a] - r[a] - i.rects.popper[l],
                    f = r[a] - i.rects.reference[a], m = Ee(s),
                    g = m ? "y" === a ? m.clientHeight || 0 : m.clientWidth || 0 : 0, v = h / 2 - f / 2, y = d[u],
                    b = g - c[l] - d[p], w = g / 2 - c[l] / 2 + v, _ = Se(y, w, b), E = a;
                i.modifiersData[n] = ((t = {})[E] = _, t.centerOffset = _ - w, t)
            }
        }, effect: function (e) {
            var t = e.state, i = e.options, n = e.name, s = i.element, r = void 0 === s ? "[data-popper-arrow]" : s,
                o = i.padding, a = void 0 === o ? 0 : o;
            null != r && ("string" != typeof r || (r = t.elements.popper.querySelector(r))) && ge(t.elements.popper, r) && (t.elements.arrow = r, t.modifiersData[n + "#persistent"] = {padding: Te("number" != typeof a ? a : Ce(a, re))})
        }, requires: ["popperOffsets"], requiresIfExists: ["preventOverflow"]
    }, Le = {top: "auto", right: "auto", bottom: "auto", left: "auto"};

    function Ie(e) {
        var t, i = e.popper, n = e.popperRect, s = e.placement, r = e.offsets, o = e.position, a = e.gpuAcceleration,
            l = e.adaptive, d = function (e) {
                var t = e.x, i = e.y, n = window.devicePixelRatio || 1;
                return {x: Math.round(t * n) / n || 0, y: Math.round(i * n) / n || 0}
            }(r), c = d.x, u = d.y, p = r.hasOwnProperty("x"), h = r.hasOwnProperty("y"), f = se, m = te, g = window;
        if (l) {
            var v = Ee(i);
            v === ce(i) && (v = be(i)), s === te && (m = ie, u -= v.clientHeight - n.height, u *= a ? 1 : -1), s === se && (f = ne, c -= v.clientWidth - n.width, c *= a ? 1 : -1)
        }
        var y, b = Object.assign({position: o}, l && Le);
        return a ? Object.assign(Object.assign({}, b), {}, ((y = {})[m] = h ? "0" : "", y[f] = p ? "0" : "", y.transform = (g.devicePixelRatio || 1) < 2 ? "translate(" + c + "px, " + u + "px)" : "translate3d(" + c + "px, " + u + "px, 0)", y)) : Object.assign(Object.assign({}, b), {}, ((t = {})[m] = h ? u + "px" : "", t[f] = p ? c + "px" : "", t.transform = "", t))
    }

    var ke = {
        name: "computeStyles", enabled: !0, phase: "beforeWrite", fn: function (e) {
            var t = e.state, i = e.options, n = i.gpuAcceleration, s = void 0 === n || n, r = i.adaptive,
                o = void 0 === r || r, a = {
        ...
        name: "eventListeners", enabled: !0, phase: "write", fn: function () {
            ...
            var t = e.state, i = e.instance, n = e.options, s = n.scroll, r = void 0 === s || s, o = n.resize,
                a = void 0 === o || o, l = ce(t.elements.popper),
                d = [].concat(t.scrollParents.reference, t.scrollParents.popper);
            return r && d.forEach((function (e) {
                e.addEventListener("scroll", i.update, Oe)
            })), a && l.addEventListener("resize", i.update, Oe), function () {
    ...
    function We(e) {
        var t = ve(e), i = t.overflow, n = t.overflowX, s = t.overflowY;
    ...
    function Re(e, t) {
        void 0 === t && (t = []);
        var i = function e(t) {
                return ["html", "body", "#document"].indexOf(de(t)) >= 0 ? t.ownerDocument.body : pe(t) && We(t) ? t : e(we(t))
            }(e), n = "body" === de(i), s = ce(i), r = n ? [s].concat(s.visualViewport || [], We(i) ? i : []) : i,
            o = t.concat(r);
    ...
    function qe(e, t) {
        return "viewport" === t ? Fe(function (e) {
            var t = ce(e), i = be(e), n = t.visualViewport, s = i.clientWidth, r = i.clientHeight, o = 0, a = 0;
            ...
            var t = be(e), i = He(e), n = e.ownerDocument.body,
                ...
                o = -i.scrollLeft + Be(e), a = -i.scrollTop;
    ...
    function Ge(e) {
        var t, i = e.reference, n = e.element, s = e.placement, r = s ? fe(s) : null, o = s ? Ye(s) : null,
    ...
    function $e(e, t) {
        void 0 === t && (t = {});
        var i = t, n = i.placement, s = void 0 === n ? e.placement : n, r = i.boundary,
            o = void 0 === r ? "clippingParents" : r, a = i.rootBoundary, l = void 0 === a ? "viewport" : a,
            d = i.elementContext, c = void 0 === d ? "popper" : d, u = i.altBoundary, p = void 0 !== u && u,
            h = i.padding, f = void 0 === h ? 0 : h, m = Te("number" != typeof f ? f : Ce(f, re)),
            g = "popper" === c ? "reference" : "popper", v = e.elements.reference, y = e.rects.popper,
            b = e.elements[p ? g : c], w = function (e, t, i) {
                var n = "clippingParents" === t ? function (e) {
                    var t = Re(we(e)), i = ["absolute", "fixed"].indexOf(ve(e).position) >= 0 && pe(e) ? Ee(e) : e;
                    return ue(i) ? t.filter((function (e) {
                        return ue(e) && ge(e, i) && "body" !== de(e)
                    })) : []
                }(e) : [].concat(t), s = [].concat(n, [i]), r = s[0], o = s.reduce((function (t, i) {
                    var n = qe(e, i);
            ...
            }(ue(b) ? b : b.contextElement || be(e.elements.popper), o, l), _ = Ne(v),
            E = Ge({reference: _, element: y, strategy: "absolute", placement: s}),
            x = Fe(Object.assign(Object.assign({}, y), E)), S = "popper" === c ? x : _, T = {
        ...
        if ("popper" === c && C) {
            ...
            Object.keys(T).forEach((function (e) {
                var t = [ne, ie].indexOf(e) >= 0 ? 1 : -1, i = [te, ie].indexOf(e) >= 0 ? "y" : "x";
                T[e] += M[i] * t
            }))
        }
        return T
    ...
    var Ve = {
        name: "flip", enabled: !0, phase: "main", fn: function (e) {
            ...
            if (!t.modifiersData[n]._skip) {
                for (var s = i.mainAxis, r = void 0 === s || s, o = i.altAxis, a = void 0 === o || o, l = i.fallbackPlacements, d = i.padding, c = i.boundary, u = i.rootBoundary, p = i.altBoundary, h = i.flipVariations, f = void 0 === h || h, m = i.allowedAutoPlacements, g = t.options.placement, v = fe(g), y = l || (v !== g && f ? function (e) {
                    if ("auto" === fe(e)) return [];
                    var t = ze(e);
                    return [je(e), t, je(t)]
                    ...
                    return e.concat("auto" === fe(i) ? function (e, t) {
                        void 0 === t && (t = {});
                        var i = t, n = i.placement, s = i.boundary, r = i.rootBoundary, o = i.padding,
                            a = i.flipVariations, l = i.allowedAutoPlacements, d = void 0 === l ? ae : l, c = Ye(n),
                            u = c ? a ? oe : oe.filter((function (e) {
                                return Ye(e) === c
                            })) : re, p = u.filter((function (e) {
                                return d.indexOf(e) >= 0
                            }));
                        0 === p.length && (p = u);
                        var h = p.reduce((function (t, i) {
                            return t[i] = $e(e, {placement: i, boundary: s, rootBoundary: r, padding: o})[fe(i)], t
                        }), {});
                ...
                }), []), w = t.rects.reference, _ = t.rects.popper, E = new Map, x = !0, S = b[0], T = 0; T < b.length; T++) {
                    var C = b[T], M = fe(C), L = "start" === Ye(C), I = [te, ie].indexOf(M) >= 0,
                        k = I ? "width" : "height",
                        O = $e(t, {placement: C, boundary: c, rootBoundary: u, altBoundary: p, padding: d}),
                        A = I ? L ? ne : se : L ? ie : te;
                    w[k] > _[k] && (A = ze(A));
                    var P = ze(A), z = [];
                    if (r && z.push(O[M] <= 0), a && z.push(O[A] <= 0, O[P] <= 0), z.every((function (e) {
                        return e
                    }))) {
                        S = C, x = !1;
                        break
    ...
    var Qe = {
        name: "hide", enabled: !0, phase: "main", requiresIfExists: ["preventOverflow"], fn: function (e) {
            var t = e.state, i = e.name, n = t.rects.reference, s = t.rects.popper, r = t.modifiersData.preventOverflow,
                o = $e(t, {elementContext: "reference"}), a = $e(t, {altBoundary: !0}), l = Xe(o, n), d = Xe(a, s, r),
                c = Ue(l), u = Ue(d);
            t.modifiersData[i] = {
        ...
        name: "offset", enabled: !0, phase: "main", requires: ["popperOffsets"], fn: function (e) {
            var t = e.state, i = e.options, n = e.name, s = i.offset, r = void 0 === s ? [0, 0] : s,
                o = ae.reduce((function (e, i) {
                    return e[i] = function (e, t, i) {
                        var n = fe(e), s = [se, te].indexOf(n) >= 0 ? -1 : 1,
                            r = "function" == typeof i ? i(Object.assign(Object.assign({}, t), {}, {placement: e})) : i,
                            o = r[0], a = r[1];
                        return o = o || 0, a = (a || 0) * s, [se, ne].indexOf(n) >= 0 ? {x: a, y: o} : {x: o, y: a}
                    }(i, t.rects, r), e
                }), {}), a = o[t.placement], l = a.x, d = a.y;
            null != t.modifiersData.popperOffsets && (t.modifiersData.popperOffsets.x += l, t.modifiersData.popperOffsets.y += d), t.modifiersData[n] = o
        }
    }, Ze = {
        ...
        name: "preventOverflow", enabled: !0, phase: "main", fn: function (e) {
            var t = e.state, i = e.options, n = e.name, s = i.mainAxis, r = void 0 === s || s, o = i.altAxis,
                a = void 0 !== o && o, l = i.boundary, d = i.rootBoundary, c = i.altBoundary, u = i.padding,
                p = i.tether, h = void 0 === p || p, f = i.tetherOffset, m = void 0 === f ? 0 : f,
                g = $e(t, {boundary: l, rootBoundary: d, padding: u, altBoundary: c}), v = fe(t.placement),
                y = Ye(t.placement), b = !y, w = xe(v), _ = "x" === w ? "y" : "x", E = t.modifiersData.popperOffsets,
                x = t.rects.reference, S = t.rects.popper,
                T = "function" == typeof m ? m(Object.assign(Object.assign({}, t.rects), {}, {placement: t.placement})) : m,
                C = {x: 0, y: 0};
            if (E) {
                if (r) {
                    var M = "y" === w ? te : se, L = "y" === w ? ie : ne, I = "y" === w ? "height" : "width", k = E[w],
                        O = E[w] + g[M], A = E[w] - g[L], P = h ? -S[I] / 2 : 0, z = "start" === y ? x[I] : S[I],
                        D = "start" === y ? -S[I] : -x[I], j = t.elements.arrow,
                        ...
                        H = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : {
                            ...
                            bottom: 0,
                            left: 0
                        }, B = H[M], W = H[L], R = Se(0, x[I], N[I]), F = b ? x[I] / 2 - P - R - B - T : z - R - B - T,
                        q = b ? -x[I] / 2 + P + R + W + T : D + R + W + T, Y = t.elements.arrow && Ee(t.elements.arrow),
                        G = Y ? "y" === w ? Y.clientTop || 0 : Y.clientLeft || 0 : 0,
                        $ = t.modifiersData.offset ? t.modifiersData.offset[t.placement][w] : 0, V = E[w] + F - $ - G,
                        X = E[w] + q - $, U = Se(h ? Math.min(O, V) : O, k, h ? Math.max(A, X) : A);
                    E[w] = U, C[w] = U - k
                }
                if (a) {
                    var Q = "x" === w ? te : se, K = "x" === w ? ie : ne, Z = E[_], J = Se(Z + g[Q], Z, Z - g[K]);
                    E[_] = J, C[_] = J - Z
                }
                t.modifiersData[n] = C
            }
    ...
    function et(e, t, i) {
        void 0 === i && (i = !1);
        var n, s, r = be(t), o = Ne(e), a = pe(t), l = {scrollLeft: 0, scrollTop: 0}, d = {x: 0, y: 0};
        return (a || !a && !i) && (("body" !== de(t) || We(r)) && (l = (n = t) !== ce(n) && pe(n) ? {
            scrollLeft: (s = n).scrollLeft,
            scrollTop: s.scrollTop
        } : He(n)), pe(t) ? ((d = Ne(t)).x += t.clientLeft, d.y += t.clientTop) : r && (d.x = Be(r))), {
    ...
    function nt(e) {
        void 0 === e && (e = {});
        var t = e, i = t.defaultModifiers, n = void 0 === i ? [] : i, s = t.defaultOptions, r = void 0 === s ? tt : s;
            ...
            var s, o, a = {
                ...
                state: a, setOptions: function (i) {
                    u(), a.options = Object.assign(Object.assign(Object.assign({}, r), a.options), i), a.scrollParents = {
                        reference: ue(e) ? Re(e) : e.contextElement ? Re(e.contextElement) : [],
                        popper: Re(t)
                    };
                    ...
                    if (!d) {
                        ...
                        if (it(t, i)) {
                            ...
                            for (var n = 0; n < a.orderedModifiers.length; n++) if (!0 !== a.reset) {
                                var s = a.orderedModifiers[n], r = s.fn, o = s.options, l = void 0 === o ? {} : o,
                                    u = s.name;
                                "function" == typeof r && (a = r({state: a, options: l, name: u, instance: c}) || a)
                            } else a.reset = !1, n = -1
                        }
                    }
                }, update: (s = function () {
    ...
    var st = nt(), rt = nt({defaultModifiers: [Ae, Ze, ke, he]}),
        ot = nt({defaultModifiers: [Ae, Ze, ke, he, Ke, Ve, Je, Me, Qe]}), at = Object.freeze({
            __proto__: null,
            popperGenerator: nt,
            detectOverflow: $e,
            createPopperBase: st,
            ...
            popperOffsets: Ze,
            preventOverflow: Je
        }), lt = "dropdown", dt = new RegExp("ArrowUp|ArrowDown|Escape"), ct = w ? "top-end" : "top-start",
        ut = w ? "top-start" : "top-end", pt = w ? "bottom-end" : "bottom-start",
        ht = w ? "bottom-start" : "bottom-end", ft = w ? "left-start" : "right-start",
        mt = w ? "right-start" : "left-start", gt = {
            offset: 0,
            flip: !0,
            ...
            return r.toggle = function () {
                ...
                if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
                    var e = s.getParentFromElement(this._element), t = {relatedTarget: this._element};
                ...
                if (!e || 2 !== e.button && ("keyup" !== e.type || "Tab" === e.key)) for (var t = G.find('[data-bs-toggle="dropdown"]'), i = 0, n = t.length; i < n; i++) {
                    var r = s.getParentFromElement(t[i]), o = x(t[i], "bs.dropdown"), a = {relatedTarget: t[i]};
                    if (e && "click" === e.type && (a.clickEvent = e), o) {
                        var l, d = o._menu;
                        if (t[i].classList.contains("show") && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && "Tab" === e.key) && d.contains(e.target) || N.trigger(r, "hide.bs.dropdown", a).defaultPrevented)) "ontouchstart" in document.documentElement && (l = []).concat.apply(l, document.body.children).forEach((function (e) {
                            return N.off(e, "mouseover", null, (function () {
                            }))
                        })), t[i].setAttribute("aria-expanded", "false"), o._popper && o._popper.destroy(), d.classList.remove("show"), t[i].classList.remove("show"), N.trigger(r, "hidden.bs.dropdown", a)
                    }
                }
                ...
                if (!(/input|textarea/i.test(e.target.tagName) ? "Space" === e.key || "Escape" !== e.key && ("ArrowDown" !== e.key && "ArrowUp" !== e.key || e.target.closest(".dropdown-menu")) : !dt.test(e.key)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !this.classList.contains("disabled"))) {
                    var t = s.getParentFromElement(this), i = this.classList.contains("show");
                    if ("Escape" === e.key) return (this.matches('[data-bs-toggle="dropdown"]') ? this : G.prev(this, '[data-bs-toggle="dropdown"]')[0]).focus(), void s.clearMenus();
                    if (i && "Space" !== e.key) {
    ...
    var bt = {backdrop: !0, keyboard: !0, focus: !0},
        wt = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean"}, _t = function (e) {
            function s(t, i) {
                var n;
            ...
            return r.toggle = function (e) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    var i = N.trigger(this._element, "show.bs.modal", {relatedTarget: e});
                ...
                var t = this, i = this._element.classList.contains("fade"), n = G.findOne(".modal-body", this._dialog);
                ...
                var s = function () {
                    t._config.focus && t._element.focus(), t._isTransitioning = !1, N.trigger(t._element, "shown.bs.modal", {relatedTarget: e})
                };
                if (i) {
                ...
                var t = this, i = this._element.classList.contains("fade") ? "fade" : "";
                ...
                if (this._isBodyOverflowing) {
                    G.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach((function (t) {
                        var i = t.style.paddingRight, n = window.getComputedStyle(t)["padding-right"];
                        Y.setDataAttribute(t, "padding-right", i), t.style.paddingRight = Number.parseFloat(n) + e._scrollbarWidth + "px"
                    })), G.find(".sticky-top").forEach((function (t) {
                        var i = t.style.marginRight, n = window.getComputedStyle(t)["margin-right"];
                        Y.setDataAttribute(t, "margin-right", i), t.style.marginRight = Number.parseFloat(n) - e._scrollbarWidth + "px"
                    }));
                    var t = document.body.style.paddingRight, i = window.getComputedStyle(document.body)["padding-right"];
                ...
                return this.each((function () {
                    var n = x(this, "bs.modal"),
                        r = i({}, bt, Y.getDataAttributes(this), "object" == typeof e && e ? e : {});
    ...
    N.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', (function (e) {
        ...
        if (e) {
            var t = e.fn.modal;
            e.fn.modal = _t.jQueryInterface, e.fn.modal.Constructor = _t, e.fn.modal.noConflict = function () {
    ...
    function Tt(e, t, i) {
        ...
        for (var s = (new window.DOMParser).parseFromString(e, "text/html"), r = Object.keys(t), o = (n = []).concat.apply(n, s.body.querySelectorAll("*")), a = function (e, i) {
            ...
            var l = (n = []).concat.apply(n, s.attributes), d = [].concat(t["*"] || [], t[a] || []);
            l.forEach((function (e) {
                (function (e, t) {
                    var i = e.nodeName.toLowerCase();
                    if (t.includes(i)) return !Et.has(i) || Boolean(e.nodeValue.match(xt) || e.nodeValue.match(St));
                    for (var n = t.filter((function (e) {
                        return e instanceof RegExp
                    })), s = 0, r = n.length; s < r; s++) if (i.match(n[s])) return !0;
                    return !1
                })(e, d) || s.removeAttribute(e.nodeName)
            }))
        }, l = 0, d = o.length; l < d; l++) a(l);
        return s.body.innerHTML
    }

    var Ct = "tooltip", Mt = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
        Lt = new Set(["sanitize", "allowList", "sanitizeFn"]), It = {
            animation: "boolean",
            template: "string",
            ...
            allowList: "object",
            popperConfig: "(null|object)"
        }, kt = {AUTO: "auto", TOP: "top", RIGHT: w ? "left" : "right", BOTTOM: "bottom", LEFT: w ? "right" : "left"},
        Ot = {
            animation: !0,
            ...
            return r.enable = function () {
                ...
                if (this._isEnabled) if (e) {
                    var t = this.constructor.DATA_KEY, i = x(e.delegateTarget, t);
                    i || (i = new this.constructor(e.delegateTarget, this._getDelegateConfig()), E(e.delegateTarget, t, i)), i._activeTrigger.click = !i._activeTrigger.click, i._isWithActiveTrigger() ? i._enter(null, i) : i._leave(null, i)
                } else {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    var t = N.trigger(this._element, this.constructor.Event.SHOW), i = function e(t) {
                    ...
                    var s = this.getTipElement(), r = o(this.constructor.NAME);
                    ...
                    E(s, this.constructor.DATA_KEY, this), this._element.ownerDocument.documentElement.contains(this.tip) || d.appendChild(s), N.trigger(this._element, this.constructor.Event.INSERTED), this._popper = ot(this._element, s, this._getPopperConfig(l)), s.classList.add("show");
                    var u, p,
                        f = "function" == typeof this.config.customClass ? this.config.customClass() : this.config.customClass;
                    f && (u = s.classList).add.apply(u, f.split(" ")), "ontouchstart" in document.documentElement && (p = []).concat.apply(p, document.body.children).forEach((function (e) {
                ...
                var e = this;
                if (this._popper) {
                    var t = this.getTipElement(), i = function () {
                ...
                var i = this.constructor.DATA_KEY;
                (t = t || x(e.delegateTarget, i)) || (t = new this.constructor(e.delegateTarget, this._getDelegateConfig()), E(e.delegateTarget, i, t)), e && (t._activeTrigger["focusout" === e.type ? "focus" : "hover"] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = "out", t.config.delay && t.config.delay.hide ? t._timeout = setTimeout((function () {
                ...
                return Object.keys(t).forEach((function (e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), f(Ct, e, this.constructor.DefaultType), e.sanitize && (e.template = Tt(e.template, e.allowList, e.sanitizeFn)), e
            }, r._getDelegateConfig = function () {
                var e = {};
                if (this.config) for (var t in this.config) this.constructor.Default[t] !== this.config[t] && (e[t] = this.config[t]);
                return e
            }, r._cleanTipClass = function () {
                var e = this.getTipElement(), t = e.getAttribute("class").match(Mt);
                ...
                return this.each((function () {
                    var t = x(this, "bs.tooltip"), i = "object" == typeof e && e;
    ...
    b((function () {
        ...
        if (e) {
            var t = e.fn[Ct];
            e.fn[Ct] = Pt.jQueryInterface, e.fn[Ct].Constructor = Pt, e.fn[Ct].noConflict = function () {
                return e.fn[Ct] = t, Pt.jQueryInterface
            }
        }
    }));
    var zt = "popover", Dt = new RegExp("(^|\\s)bs-popover\\S+", "g"), jt = i({}, Pt.Default, {
        placement: "right",
        trigger: "click",
        content: "",
        template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
    }), Nt = i({}, Pt.DefaultType, {content: "(string|element|function)"}), Ht = {
        ...
        return s.isWithContent = function () {
            ...
            var e = this.getTipElement(), t = e.getAttribute("class").match(Dt);
            null !== t && t.length > 0 && t.map((function (e) {
                return e.trim()
            })).forEach((function (t) {
                return e.classList.remove(t)
            ...
            return this.each((function () {
                var t = x(this, "bs.popover"), n = "object" == typeof e ? e : null;
                if ((t || !/dispose|hide/.test(e)) && (t || (t = new i(this, n), E(this, "bs.popover", t)), "string" == typeof e)) {
                    if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                    t[e]()
                }
            }))
    ...
    b((function () {
        ...
        if (e) {
            var t = e.fn[zt];
            e.fn[zt] = Bt.jQueryInterface, e.fn[zt].Constructor = Bt, e.fn[zt].noConflict = function () {
                return e.fn[zt] = t, Bt.jQueryInterface
            }
        }
    }));
    var Wt = "scrollspy", Rt = {offset: 10, method: "auto", target: ""},
        Ft = {offset: "number", method: "string", target: "(string|element)"}, qt = function (e) {
            function s(t, i) {
                var n;
            ...
            return r.refresh = function () {
                ...
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), G.find(this._selector).map((function (e) {
                    var t = l(e), s = t ? G.findOne(t) : null;
                    if (s) {
                ...
                if ("string" != typeof (e = i({}, Rt, "object" == typeof e && e ? e : {})).target && p(e.target)) {
                    var t = e.target.id;
    ...
    N.on(window, "load.bs.scrollspy.data-api", (function () {
        ...
        if (e) {
            var t = e.fn[Wt];
            e.fn[Wt] = qt.jQueryInterface, e.fn[Wt].Constructor = qt, e.fn[Wt].noConflict = function () {
    ...
    var Yt = function (e) {
        ...
        return s.show = function () {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains("active") || this._element.classList.contains("disabled"))) {
                ...
                var r = null;
                if (t && (r = N.trigger(t, "hide.bs.tab", {relatedTarget: this._element})), !(N.trigger(this._element, "show.bs.tab", {relatedTarget: t}).defaultPrevented || null !== r && r.defaultPrevented)) {
                    this._activate(this._element, n);
                    var o = function () {
                        N.trigger(t, "hidden.bs.tab", {relatedTarget: e._element}), N.trigger(e._element, "shown.bs.tab", {relatedTarget: t})
                    };
            ...
            var n = this,
                s = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? G.children(t, ".active") : G.find(":scope > li > .active", t))[0],
                r = i && s && s.classList.contains("fade"), o = function () {
    ...
    var Gt = {animation: "boolean", autohide: "boolean", delay: "number"},
        $t = {animation: !0, autohide: !0, delay: 5e3}, Vt = function (e) {
            function s(t, i) {
                var n;
            ...
            return r.show = function () {
                ...
                return e = i({}, $t, Y.getDataAttributes(this._element), "object" == typeof e && e ? e : {}), f("toast", e, this.constructor.DefaultType), e
            }, r._setListeners = function () {
                var e = this;
    ...
    var o = e.jQuery, a = e.console, l = Array.prototype.slice;
    ...
    function i(i, r, a) {
        (a = a || t || e.jQuery) && (r.prototype.option || (r.prototype.option = function (e) {
            ...
            var t, n, l, d, c, u, p = s.call(arguments, 1);
            return l = p, c = "$()." + i + '("' + (n = e) + '")', (t = this).each((function (e, t) {
                var s = a.data(t, i);
                if (s) {
                    var r = s[n];
                    if (r && "_" != n.charAt(0)) {
    ...
    var s = Array.prototype.slice, r = e.console, o = void 0 === r ? function () {
    } : function (e) {
        r.error(e)
    };
    ...
    return function n(a) {
        if (function () {
            ...
            for (var c = d.isBorderBox = "border-box" == l.boxSizing, u = 0; u < r; u++) {
                var p = s[u], h = l[p], f = parseFloat(h);
                d[p] = isNaN(f) ? 0 : f
            }
            var m = d.paddingLeft + d.paddingRight, g = d.paddingTop + d.paddingBottom,
                ...
                b = d.borderLeftWidth + d.borderRightWidth, w = d.borderTopWidth + d.borderBottomWidth, _ = c && i,
                E = e(l.width);
            !1 !== E && (d.width = E + (_ ? 0 : m + b));
            var x = e(l.height);
            return !1 !== x && (d.height = x + (_ ? 0 : g + w)), d.innerWidth = d.width - (m + b), d.innerHeight = d.height - (g + w), d.outerWidth = d.width + v, d.outerHeight = d.height + y, d
        }
    }
})), function (e, t) {
    "use strict";
    ...
    return i.htmlInit = function (t, n) {
        i.docReady((function () {
            var r = i.toDashed(n), o = "data-" + r, a = document.querySelectorAll("[" + o + "]"),
                l = document.querySelectorAll(".js-" + r), d = i.makeArray(a).concat(i.makeArray(l)),
                c = o + "-options", u = e.jQuery;
    ...
    var n = document.documentElement.style, s = "string" == typeof n.transition ? "transition" : "WebkitTransition",
        ...
        o = {WebkitTransition: "webkitTransitionEnd", transition: "transitionend"}[s], a = {
            transform: r,
            transition: s,
    ...
    l.constructor = i, l._create = function () {
        ...
        var e = getComputedStyle(this.element), t = this.layout._getOption("originLeft"),
            ...
            r = parseFloat(n), o = parseFloat(s), a = this.layout.size;
        -1 != n.indexOf("%") && (r = r / 100 * a.width), -1 != s.indexOf("%") && (o = o / 100 * a.height), r = isNaN(r) ? 0 : r, o = isNaN(o) ? 0 : o, r -= t ? a.paddingLeft : a.paddingRight, o -= i ? a.paddingTop : a.paddingBottom, this.position.x = r, this.position.y = o
    }, l.layoutPosition = function () {
        var e = this.layout.size, t = {}, i = this.layout._getOption("originLeft"),
            n = this.layout._getOption("originTop"), s = i ? "paddingLeft" : "paddingRight", r = i ? "left" : "right",
            o = i ? "right" : "left", a = this.position.x + e[s];
    ...
    var d = "opacity," + r.replace(/([A-Z])/g, (function (e) {
        return "-" + e.toLowerCase()
    }));
    ...
    l.ontransitionend = function (e) {
        if (e.target === this.element) {
            var t = this._transn, i = c[e.propertyName] || e.propertyName;
    ...
    var a = e.console, l = e.jQuery, d = function () {
    }, c = 0, u = {};
    ...
    return n._resetLayout = function () {
        ...
        for (var l = (this._getOption("originTop") ? n.top : n.bottom) + i.outerHeight, d = o; d <= a; d++) this.colYs[d] = Math.max(l, this.colYs[d])
    ...
    var u = function (e) {
        ...
        var t, i, n = l(e).split(" "), s = n[0], r = s.match(/^\[(.+)\]$/), o = r && r[1],
        ...
        if (this.options.sortBy) {
            ...
            var t = (i = this.sortHistory, n = this.options.sortAscending, function (e, t) {
                for (var s = 0; s < i.length; s++) {
                    var r = i[s], o = e.sortData[r], a = t.sortData[r];
    ...
    e.cleanData = (t = e.cleanData, function (i) {
        for (var n, s, r = 0; null != (s = i[r]); r++) try {
            (n = e._data(s, "events")) && n.remove && e(s).triggerHandler("remove")
        } catch (i) {
        }
        t(i)
    }), e.widget = function (t, i, n) {
        var s, r, o, a = {}, l = t.split(".")[0], d = l + "-" + (t = t.split(".")[1]);
        ...
        })), r.prototype = e.widget.extend(o, {widgetEventPrefix: s && o.widgetEventPrefix || t}, a, {
            constructor: r,
            namespace: l,
            widgetName: t,
            widgetFullName: d
        ...
        for (var i, s, r = n.call(arguments, 1), o = 0, a = r.length; o < a; o++) for (i in r[o]) s = r[o][i], r[o].hasOwnProperty(i) && void 0 !== s && (e.isPlainObject(s) ? t[i] = e.isPlainObject(t[i]) ? e.widget.extend({}, t[i], s) : e.widget.extend({}, s) : t[i] = s);
        return t
        ...
        option: function (t, i) {
            ...
            if ("string" == typeof t) if (o = {}, t = (n = t.split(".")).shift(), n.length) {
                for (s = o[t] = e.widget.extend({}, this.options[t]), r = 0; r < n.length - 1; r++) s[n[r]] = s[n[r]] || {}, s = s[n[r]];
        ...
        _classes: function (t) {
            ...
            function s(s, r) {
                for (var o, a = 0; a < s.length; a++) o = n.classesElementLookup[s[a]] || e(), o = t.add ? e(e.unique(o.get().concat(t.element.get()))) : e(o.not(t.element).get()), n.classesElementLookup[s[a]] = o, i.push(s[a]), r && t.classes[s[a]] && i.push(t.classes[s[a]])
            }
        ...
        _on: function (t, i, n) {
            ...
            "boolean" != typeof t && (n = i, i = t, t = !1), n ? (i = s = e(i), this.bindings = this.bindings.add(i)) : (n = i, i = this.element, s = this.widget()), e.each(n, (function (n, o) {
                ...
                var l;
                "string" != typeof o && (a.guid = o.guid = o.guid || a.guid || e.guid++), n = (l = n.match(/^([\w:-]*)\s*(.*)$/))[1] + r.eventNamespace, (l = l[2]) ? s.on(n, l, a) : i.on(n, a)
            }))
        },
        _off: function (t, i) {
        ...
        e.Widget.prototype["_" + t] = function (n, s, r) {
            ...
            "number" == typeof (s = s || {}) && (s = {duration: s}), o = !e.isEmptyObject(s), s.complete = r, s.delay && n.delay(s.delay), o && e.effects && e.effects.effect[a] ? n[t](s) : a !== t && n[a] ? n[a](s.duration, s.easing, r) : n.queue((function (i) {
    ...
    e(document).on("mouseup", (function () {
        ...
        _mouseDown: function (t) {
            if (!s) {
                ...
                return !(n && !r && this._mouseCapture(t)) || (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout((function () {
                    i.mouseDelayMet = !0
                    ...
                    return i._mouseUp(e)
                }, this.document.on("mousemove." + this.widgetName, this._mouseMoveDelegate).on("mouseup." + this.widgetName, this._mouseUpDelegate), t.preventDefault(), s = !0))
            }
        },
        ...
        _createHandles: function () {
            var t, i = this.options, n = this.element.find(".ui-slider-handle"), s = [],
                r = i.values && i.values.length || 1;
            for (n.length > r && (n.slice(r).remove(), n = n.slice(0, r)), t = n.length; t < r; t++) s.push("<span tabindex='0'></span>");
            this.handles = n.add(e(s.join("")).appendTo(this.element)), this._addClass(this.handles, "ui-slider-handle", "ui-state-default"), this.handle = this.handles.eq(0), this.handles.each((function (t) {
        ...
        _mouseCapture: function (t) {
            var i, n, s, r, o, a, l = this, d = this.options;
            return !d.disabled && (this.elementSize = {
                ...
                (o < n || n === o && (t === l._lastChangedValue || l.values(t) === d.min)) && (n = o, s = e(this), r = t)
            })), !1 !== this._start(t, r) && (this._mouseSliding = !0, this._handleIndex = r, this._addClass(s, null, "ui-state-active"), s.trigger("focus"), o = s.offset(), a = !e(t.target).parents().addBack().is(".ui-slider-handle"), this._clickOffset = a ? {
                left: 0,
                top: 0
            } : {
        ...
        _uiHash: function (e, t, i) {
            var n = {handle: this.handles[e], handleIndex: e, value: void 0 !== t ? t : this.value()};
        ...
        values: function (t, i) {
            ...
            for (n = this.options.values, s = t, r = 0; r < n.length; r += 1) n[r] = this._trimAlignValue(s[r]), this._change(null, r);
            this._refreshValue()
        },
        ...
        _refreshValue: function () {
            var t, i, n, s, r, o = this.options.range, a = this.options, l = this, d = !this._animateOff && a.animate,
                c = {};
            this._hasMultipleValues() ? this.handles.each((function (n) {
                i = (l.values(n) - l._valueMin()) / (l._valueMax() - l._valueMin()) * 100, c["horizontal" === l.orientation ? "left" : "bottom"] = i + "%", e(this).stop(1, 1)[d ? "animate" : "css"](c, a.animate), !0 === l.options.range && ("horizontal" === l.orientation ? (0 === n && l.range.stop(1, 1)[d ? "animate" : "css"]({left: i + "%"}, a.animate), 1 === n && l.range[d ? "animate" : "css"]({width: i - t + "%"}, {
                    queue: !1,
                    duration: a.animate
                })) : (0 === n && l.range.stop(1, 1)[d ? "animate" : "css"]({bottom: i + "%"}, a.animate), 1 === n && l.range[d ? "animate" : "css"]({height: i - t + "%"}, {
                    queue: !1,
                    duration: a.animate
                }))), t = i
        ...
        _handleEvents: {
            keydown: function (t) {
                ...
                switch (s = this.options.step, i = n = this._hasMultipleValues() ? this.values(r) : this.value(), t.keyCode) {
                    case e.ui.keyCode.HOME:
                        n = this._valueMin();
                        break;
                    case e.ui.keyCode.END:
    ...
    t.prototype.add = function (e) {
        ...
        for (var i in t) {
            ...
            for (var r in this.waypoints[i]) {
                var o = this.waypoints[i][r], a = n.oldScroll < o.triggerPoint, l = n.newScroll >= o.triggerPoint;
        ...
        for (var r in this.handleScroll(), e = {
            ...
            for (var a in this.waypoints[r]) {
                var l, d, c, u, p = this.waypoints[r][a], h = p.options.offset, f = p.triggerPoint, m = 0,
                    g = null == f;
...
*/
        ...
        e.fn.counterUp = function (t) {
            ...
            return this.each((function () {
                ...
                t.waypoint((function (r) {
                    !function () {
                        var r = [], o = s.time / s.delay,
                            a = e(this).attr("data-num") ? e(this).attr("data-num") : t.text(),
                            l = /[0-9]+,[0-9]+/.test(a), d = ((a = a.replace(/,/g, "")).split(".")[1] || []).length;
    ...
    var t, i, n, s, r, o, a = "Close", l = "BeforeClose", d = "MarkupParse", c = "Open", u = "Change", p = "mfp",
        h = ".mfp", f = "mfp-ready", m = "mfp-removing", g = "mfp-prevent-close", v = function () {
    ...
    v.prototype = {
        constructor: v, init: function () {
            ...
            if (!1 === i.isObj) {
                ...
                var o, a = i.items;
                for (s = 0; s < a.length; s++) if ((o = a[s]).parsed && (o = o.el[0]), o === i.el[0]) {
                    t.index = s;
                    break
                }
            ...
            if (s.tagName ? s = {el: e(s)} : (n = s.type, s = {data: s, src: s.src}), s.el) {
                for (var r = t.types, o = 0; o < r.length; o++) if (s.el.hasClass("mfp-" + r[o])) {
                    n = r[o];
                    break
                }
        ...
        options: {
            ...
            initZoom: function () {
                ...
                if (i.enabled && t.supportsTransition) {
                    var s, r, o = i.duration, d = function (e) {
                ...
                var n, s = (n = i ? t.currItem.img : t.st.zoom.opener(t.currItem.el || t.currItem)).offset(),
                    r = parseInt(n.css("padding-top"), 10), o = parseInt(n.css("padding-bottom"), 10);
                s.top -= e(window).scrollTop() - r;
                var a = {width: n.width(), height: (y ? n.innerHeight() : n[0].offsetHeight) - o - r};
...
var Swiper = function () {
    ...
    function p(e) {
        ...
        const s = r(), o = -t.translate;
        let a, l = null;
        const d = t.params.speed;
        t.wrapperEl.style.scrollSnapType = "none", s.cancelAnimationFrame(t.cssModeFrameID);
        const c = i > o ? "next" : "prev", u = (e, t) => "next" === c && e >= t || "prev" === c && e <= t, p = () => {
            a = (new Date).getTime(), null === l && (l = a);
            const e = Math.max(Math.min((a - l) / d, 1), 0), r = .5 - Math.cos(e * Math.PI) / 2;
            let c = o + r * (i - o);
            if (u(c, i) && (c = i), t.wrapperEl.scrollTo({[n]: c}), u(c, i)) return t.wrapperEl.style.overflow = "hidden", t.wrapperEl.style.scrollSnapType = "", setTimeout(() => {
    ...
    function g(e) {
        const t = r(), i = n(), s = e.getBoundingClientRect(), o = i.body, a = e.clientTop || o.clientTop || 0,
            l = e.clientLeft || o.clientLeft || 0, d = e === t ? t.scrollY : e.scrollTop,
    ...
    function C(e) {
        return void 0 === e && (e = {}), x || (x = function (e) {
            ...
            const i = T(), n = r(), s = n.navigator.platform, o = t || n.navigator.userAgent,
                a = {ios: !1, android: !1}, l = n.screen.width, d = n.screen.height,
    ...
    const L = (e, t) => {
        ...
        if (e.params.grid && e.params.grid.rows > 1) {
            const i = s, r = [i - t];
            return r.push(...Array.from({length: t}).map((e, t) => i + n + t)), void e.slides.forEach((t, i) => {
        ...
        if (e.params.rewind || e.params.loop) for (let n = s - t; n <= r + t; n += 1) {
            const t = (n % i + i) % i;
            (t < s || t > r) && I(e, t)
        } else for (let n = Math.max(s - t, 0); n <= Math.min(r + t, i - 1); n += 1) n !== s && (n > r || n < s) && I(e, n)
    };
    ...
    function A(e) {
        const t = this, i = n(), s = r(), o = t.touchEventsData;
        o.evCache.push(e);
        ...
        const v = d.currentX, y = d.currentY, b = l.edgeSwipeDetection || l.iOSEdgeSwipeDetection,
    ...
    function P(e) {
        const t = n(), i = this, s = i.touchEventsData, {params: r, touches: o, rtlTranslate: l, enabled: d} = i;
        if (!d) return;
        ...
        u >= 0 && (s.evCache[u] = c);
        const p = s.evCache.length > 1 ? s.evCache[0] : c, h = p.pageX, f = p.pageY;
        ...
        let v = i.isHorizontal() ? m : g, y = i.isHorizontal() ? o.currentX - o.previousX : o.currentY - o.previousY;
        ...
        if (!s.isMoved) {
            if (w && _ && i.loopFix({direction: i.swipeDirection}), s.startTranslate = i.getTranslate(), i.setTransition(0), i.animating) {
    ...
    function z(e) {
        ...
        const {params: s, touches: r, rtlTranslate: l, slidesGrid: d, enabled: c} = t;
        if (!c) return;
        ...
        const b = (f - d[m]) / g, w = m < s.slidesPerGroupSkip - 1 ? 1 : s.slidesPerGroup;
        if (h > s.longSwipesMs) {
    ...
    function D() {
        ...
        const {allowSlideNext: n, allowSlidePrev: s, snapGrid: r} = e, o = e.virtual && e.params.virtual.enabled;
    ...
    function Y(e, t) {
        return function (i) {
            ...
            "object" == typeof s && null !== s ? (!0 === e[n] && (e[n] = {enabled: !0}), "navigation" === n && e[n] && e[n].enabled && !e[n].prevEl && !e[n].nextEl && (e[n].auto = !0), ["pagination", "scrollbar"].indexOf(n) >= 0 && e[n] && e[n].enabled && !e[n].el && (e[n].auto = !0), n in e && "enabled" in s ? ("object" != typeof e[n] || "enabled" in e[n] || (e[n].enabled = !0), e[n] || (e[n] = {enabled: !1}), c(t, i)) : c(t, i)) : c(t, i)
        }
    }
    ...
    const G = {
        eventsEmitter: {
            ...
            updateSize: function () {
                ...
                const n = e.params, {wrapperEl: s, slidesEl: r, size: o, rtlTranslate: a, wrongRTL: l} = e,
                    d = e.virtual && n.virtual.enabled, c = d ? e.virtual.slides.length : e.slides.length,
                    p = f(r, `.${e.params.slideClass}, swiper-slide`), h = d ? e.virtual.slides.length : p.length;
                let m = [];
                const g = [], y = [];
                ...
                const E = e.snapGrid.length, x = e.slidesGrid.length;
                let S = n.spaceBetween, T = -b, C = 0, M = 0;
                if (void 0 === o) return;
                ...
                for (let s = 0; s < h; s += 1) {
                    ...
                    if (I = 0, p[s] && (r = p[s]), L && e.grid.updateSlide(s, r, h, t), !p[s] || "none" !== v(r, "display")) {
                        if ("auto" === n.slidesPerView) {
                            k && (p[s].style[t("width")] = "");
                            const o = getComputedStyle(r), a = r.style.transform, l = r.style.webkitTransform;
                            if (a && (r.style.transform = "none"), l && (r.style.webkitTransform = "none"), n.roundLengths) I = e.isHorizontal() ? _(r, "width", !0) : _(r, "height", !0); else {
                                const e = i(o, "width"), t = i(o, "padding-left"), n = i(o, "padding-right"),
                                    s = i(o, "margin-left"), a = i(o, "margin-right"),
                                    l = o.getPropertyValue("box-sizing");
                                if (l && "border-box" === l) I = e + s + a; else {
                ...
                if (i.loop) {
                    const i = t.getSlideIndexByData(0), n = t.getSlideIndexByData(t.slides.length - 1),
                        s = t.slidesGrid[i], r = t.slidesGrid[n], o = t.slidesGrid[t.slidesGrid.length - 1],
                        l = Math.abs(e);
                ...
                const e = this, {slides: t, params: i, slidesEl: n, activeIndex: s} = e,
                    r = e.virtual && i.virtual.enabled, o = e => f(n, `.${i.slideClass}${e}, swiper-slide${e}`)[0];
                let a;
                if (t.forEach(e => {
                ...
                } else a = o(`[data-swiper-slide-index="${s}"]`); else a = t[s];
                if (a) {
            ...
            getTranslate: function (e) {
                ...
                const i = this, {rtlTranslate: n, params: s, wrapperEl: r, progress: o} = i;
                let a, l = 0, d = 0;
            ...
            slideTo: function (e, t, i, n, s) {
                ...
                if (a.normalizeSlideIndex) for (let e = 0; e < d.length; e += 1) {
                    const t = -Math.floor(100 * y), i = Math.floor(100 * d[e]), n = Math.floor(100 * d[e + 1]);
                ...
                if (a.cssMode) {
                    const e = r.isHorizontal(), i = h ? y : -y;
                    if (0 === t) {
                ...
                const n = this, {enabled: s, params: r, animating: o} = n;
                if (!s) return n;
                let a = r.slidesPerGroup;
                "auto" === r.slidesPerView && 1 === r.slidesPerGroup && r.slidesPerGroupAuto && (a = Math.max(n.slidesPerViewDynamic("current", !0), 1));
                const l = n.activeIndex < r.slidesPerGroupSkip ? 1 : a, d = n.virtual && r.virtual.enabled;
                if (r.loop) {
                    if (o && !d && r.loopPreventsSliding) return !1;
                    if (n.loopFix({direction: "next"}), n._clientLeft = n.wrapperEl.clientLeft, n.activeIndex === n.slides.length - 1 && r.cssMode) return requestAnimationFrame(() => {
                ...
                void 0 === e && (e = this.params.speed), void 0 === t && (t = !0);
                const n = this, {params: s, snapGrid: r, slidesGrid: o, rtlTranslate: a, enabled: l, animating: d} = n;
                if (!l) return n;
                ...
                const p = u(a ? n.translate : -n.translate), h = r.map(e => u(e));
            ...
            loopCreate: function (e) {
                ...
                } else s && (l.slideToLoop(t, 0, !1, !0), l.touchEventsData.currentTranslate = l.translate); else if (v.length > 0 && b) if (void 0 === t) {
                    const e = l.slidesGrid[y], t = l.slidesGrid[y - E] - e;
                ...
                if (l.allowSlidePrev = c, l.allowSlideNext = u, l.controller && l.controller.control && !o) {
                    const e = {slideRealIndex: t, direction: n, setTranslate: s, activeSlideIndex: r, byController: !0};
            ...
            setBreakpoint: function () {
                ...
                let n = !1;
                const s = r(), o = "window" === t ? s.innerHeight : i.clientHeight, a = Object.keys(e).map(e => {
            ...
            addClasses: function () {
                const e = this, {classNames: t, params: i, rtl: n, el: s, device: r} = e, o = function (e, t) {
                    const i = [];
                    return e.forEach(e => {
                ...
                }(["initialized", i.direction, {"free-mode": e.params.freeMode && i.freeMode.enabled}, {autoheight: i.autoHeight}, {rtl: n}, {grid: i.grid && i.grid.rows > 1}, {"grid-column": i.grid && i.grid.rows > 1 && "column" === i.grid.fill}, {android: r.android}, {ios: r.ios}, {"css-mode": i.cssMode}, {centered: i.cssMode && i.centeredSlides}, {"watch-progress": i.watchSlidesProgress}], i.containerModifierClass);
    ...
    class V {
        constructor() {
            ...
            const a = this;
            a.__swiper__ = !0, a.support = T(), a.device = C({userAgent: t.userAgent}), a.browser = M(), a.eventsListeners = {}, a.eventsAnyListeners = [], a.modules = [...a.__modules__], t.modules && Array.isArray(t.modules) && a.modules.push(...t.modules);
            const l = {};
            a.modules.forEach(e => {
                e({
                    params: t,
        ...
        slidesPerViewDynamic(e, t) {
            ...
            } else if ("current" === e) for (let e = a + 1; e < n.length; e += 1) (t ? s[e] + r[e] - s[a] < o : s[e] - s[a] < o) && (l += 1); else for (let e = a - 1; e >= 0; e -= 1) s[a] - s[e] < o && (l += 1);
            return l
        }
        ...
        destroy(e, t) {
            ...
            const i = this, {params: n, el: s, wrapperEl: r, slides: o} = i;
    ...
    const re = [function (e) {
        ...
        function c(e) {
            const {slidesPerView: t, slidesPerGroup: n, centeredSlides: s, loop: r} = i.params, {
                addSlidesBefore: a,
                addSlidesAfter: l
            } = i.params.virtual, {from: c, to: u, slides: p, slidesGrid: h, offset: m} = i.virtual;
            ...
            if (e) i.slides.filter(e => e.matches(`.${i.params.slideClass}, swiper-slide`)).forEach(e => {
                e.remove()
            }); else for (let e = c; e <= u; e += 1) if (e < w || e > _) {
                const t = C(e);
            ...
            const M = r ? -p.length : 0, L = r ? 2 * p.length : p.length;
            for (let t = M; t < L; t += 1) if (t >= w && t <= _) {
                const i = C(t);
                void 0 === u || e ? T.push(i) : (t > u && T.push(i), t < c && S.push(i))
            }
            if (T.forEach(e => {
                i.slidesEl.append(d(p[e], e))
            }), r) for (let e = S.length - 1; e >= 0; e -= 1) {
                const t = S[e];
        ...
        r("beforeInit", () => {
            ...
            appendSlide: function (e) {
                ...
                if (null == e) return;
                let t = i.activeIndex;
                if (Array.isArray(e)) for (let n = e.length - 1; n >= 0; n -= 1) i.params.virtual.cache && (delete i.virtual.cache[e[n]], Object.keys(i.virtual.cache).forEach(t => {
                ...
                })), i.virtual.slides.splice(e[n], 1), e[n] < t && (t -= 1), t = Math.max(t, 0); else i.params.virtual.cache && (delete i.virtual.cache[e], Object.keys(i.virtual.cache).forEach(t => {
                    t > e && (i.virtual.cache[t - 1] = i.virtual.cache[t], i.virtual.cache[t - 1].setAttribute("data-swiper-slide-index", t - 1), delete i.virtual.cache[t])
        ...
        function d(e) {
            ...
            const s = n.keyCode || n.charCode, r = t.params.keyboard.pageUpDown, d = r && 33 === s, c = r && 34 === s,
            ...
            if (!(n.shiftKey || n.altKey || n.ctrlKey || n.metaKey || a.activeElement && a.activeElement.nodeName && ("input" === a.activeElement.nodeName.toLowerCase() || "textarea" === a.activeElement.nodeName.toLowerCase()))) {
                if (t.params.keyboard.onlyInViewport && (d || c || u || p || h || f)) {
                    ...
                    const n = t.el, s = n.clientWidth, r = n.clientHeight, o = l.innerWidth, a = l.innerHeight,
                        d = g(n);
                    i && (d.left -= n.scrollLeft);
                    const c = [[d.left, d.top], [d.left + s, d.top], [d.left, d.top + r], [d.left + s, d.top + r]];
        ...
        function u(e) {
            ...
            if (t.params.loop) {
                ...
                const e = t.realIndex, i = t.getSlideIndexByData(n), s = t.getSlideIndexByData(t.realIndex), r = n => {
                ...
                if (i > t.slides.length - t.loopedSlides) r(i > s ? "next" : "prev"); else if (t.params.centeredSlides) {
        ...
        function p() {
            ...
            if (t.params.loop ? (r = t.previousRealIndex || 0, n = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (n = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, n = t.activeIndex || 0), "bullets" === i.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                ...
                if (i.dynamicBullets) {
                    const n = Math.min(s.length, i.dynamicMainBullets + 4), r = (o * n - o) / 2 - p * o,
                        a = e ? "right" : "left";
                    s.forEach(e => {
        ...
        function f() {
            t.params.pagination = X(t, t.originalParams.pagination, t.params.pagination, {el: "swiper-pagination"});
            const e = t.params.pagination;
            if (!e.el) return;
            let i;
        ...
        const a = n();
        let l, d, c, u, p = !1, h = null, f = null;

        function v() {
            if (!t.params.scrollbar.el || !t.scrollbar.el) return;
            const {scrollbar: e, rtlTranslate: i} = t, {dragEl: n, el: s} = e, r = t.params.scrollbar,
        ...
        function _(e) {
            const i = t.params.scrollbar, {scrollbar: n, wrapperEl: s} = t, {el: o, dragEl: a} = n;
        ...
        function E(e) {
            const {scrollbar: i, wrapperEl: n} = t, {el: s, dragEl: o} = i;
        ...
        function S(e) {
            ...
            if (!s) return;
            const r = s, o = !!n.passiveListeners && {passive: !1, capture: !1},
        ...
        function T() {
            ...
            t.params.scrollbar = X(t, t.originalParams.scrollbar, t.params.scrollbar, {el: "swiper-scrollbar"});
        ...
        }), t.scrollbar = {el: null, dragEl: null}, s("init", () => {
        ...
        Object.assign(t.scrollbar, {
            ...
            }, disable: M, updateSize: y, setTranslate: v, init: T, destroy: C
        })
    }, function (e) {
        ...
        const s = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]",
            r = (e, i) => {
                ...
                let o = e.getAttribute("data-swiper-parallax-x"), a = e.getAttribute("data-swiper-parallax-y");
                ...
                const {el: e, slides: i, progress: n, snapGrid: o, isElement: a} = t, l = f(e, s);
        ...
        function T(e) {
            ...
            const r = (i.scale - c) / (h.maxRatio - t.params.zoom.minRatio), {originX: o, originY: a} = h;
        ...
        }), Object.assign(t.zoom, {enable: O, disable: A, in: M, out: L, toggle: I})
    }, function (e) {
        let {swiper: t, extendParams: i, on: n} = e;
        ...
        const b = (e, t, i) => {
            a(e), "BUTTON" !== e.tagName && (d(e, "button"), e.addEventListener("keydown", f)), u(e, i), function (e, t) {
                (e = o(e)).forEach(e => {
        ...
        let {swiper: t, extendParams: i, emit: s, on: o} = e, a = !1;
        const l = n(), d = r();
        i({
            hashNavigation: {
        ...
        s.autoplay = {running: !1, paused: !1, timeLeft: 0}, r({
            autoplay: {
                enabled: !1,
                delay: 3e3,
                waitForTransition: !0,
        ...
        function l() {
            ...
            if (e.swiper instanceof i) t.thumbs.swiper = e.swiper, Object.assign(t.thumbs.swiper.originalParams, {
                ...
                Object.assign(n, {watchSlidesProgress: !0, slideToClickedSlide: !1}), t.thumbs.swiper = new i(n), o = !0
            }
        ...
        function c(e) {
            ...
            if (t.params.slidesPerView > 1 && !t.params.centeredSlides && (s = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (s = 1), s = Math.floor(s), i.slides.forEach(e => e.classList.remove(r)), i.params.loop || i.params.virtual && i.params.virtual.enabled) for (let e = 0; e < s; e += 1) f(i.slidesEl, `[data-swiper-slide-index="${t.realIndex + e}"]`).forEach(e => {
                e.classList.add(r)
            }); else for (let e = 0; e < s; e += 1) i.slides[t.realIndex + e] && i.slides[t.realIndex + e].classList.add(r);
            const o = t.params.thumbs.autoScrollOffset, a = o && !i.params.loop;
        ...
        i({
            ...
            freeMode: {
                onTouchStart: function () {
                    ...
                    let {currentPos: i} = e;
                    if (t.params.cssMode) return;
                    const {params: r, wrapperEl: o, rtlTranslate: l, snapGrid: d, touchEventsData: c} = t,
                        u = a() - c.touchStartTime;
                    if (i < -t.minTranslate()) t.slideTo(t.activeIndex); else if (i > -t.maxTranslate()) t.slides.length < d.length ? t.slideTo(d.length - 1) : t.slideTo(t.slides.length - 1); else {
                        if (r.freeMode.momentum) {
                            ...
                            if (u < t.maxTranslate()) r.freeMode.momentumBounce ? (u + t.maxTranslate() < -f && (u = t.maxTranslate() - f), p = t.maxTranslate(), h = !0, c.allowMomentumBounce = !0) : u = t.maxTranslate(), r.loop && r.centeredSlides && (m = !0); else if (u > t.minTranslate()) r.freeMode.momentumBounce ? (u - t.minTranslate() > f && (u = t.minTranslate() + f), p = t.minTranslate(), h = !0, c.allowMomentumBounce = !0) : u = t.minTranslate(), r.loop && r.centeredSlides && (m = !0); else if (r.freeMode.sticky) {
                                let e;
                                for (let t = 0; t < d.length; t += 1) if (d[t] > -u) {
                                    e = t;
                                    break
                                }
        ...
        a("init", () => {
            ...
            initSlides: e => {
                ...
                const {slidesPerGroup: d} = r.params, c = l(), {rows: u, fill: p} = r.params.grid;
                let h, f, m;
                if ("row" === p && d > 1) {
                    const i = Math.floor(e / (d * u)), n = e - u * d * i,
                ...
                const {centeredSlides: s, roundLengths: o} = r.params, a = l(), {rows: d} = r.params.grid;
        ...
        te({
            ...
            setTranslate: () => {
                const {el: e, wrapperEl: i, slides: n, width: r, height: o, rtlTranslate: a, size: l, browser: d} = t,
                    c = t.params.cubeEffect, u = t.isHorizontal(), p = t.virtual && t.params.virtual.enabled;
                let h, f = 0;
                ...
                if (i.style.transformOrigin = `50% 50% -${l / 2}px`, i.style["-webkit-transform-origin"] = `50% 50% -${l / 2}px`, c.shadow) if (u) h.style.transform = `translate3d(0px, ${r / 2 + c.shadowOffset}px, ${-r / 2}px) rotateX(90deg) rotateZ(0deg) scale(${c.shadowScale})`; else {
                    const e = Math.abs(f) - 90 * Math.floor(Math.abs(f) / 90),
                        t = 1.5 - (Math.sin(2 * e * Math.PI / 360) / 2 + Math.cos(2 * e * Math.PI / 360) / 2),
                        i = c.shadowScale, n = c.shadowScale / t, s = c.shadowOffset;
        ...
        te({
            ...
            setTranslate: () => {
                ...
                for (let r = 0; r < e.length; r += 1) {
                    ...
                    let d = -180 * a, c = 0, u = t.params.cssMode ? -l - t.translate : -l, p = 0;
        ...
        let {swiper: t, extendParams: i, on: n} = e;
        i({coverflowEffect: {rotate: 50, stretch: 0, depth: 100, scale: 1, modifier: 1, slideShadows: !0}}), te({
            effect: "coverflow", swiper: t, on: n, setTranslate: () => {
                const {width: e, height: i, slides: n, slidesSizesGrid: s} = t, r = t.params.coverflowEffect,
                    o = t.isHorizontal(), a = t.translate, l = o ? e / 2 - a : i / 2 - a, d = o ? r.rotate : -r.rotate,
                    c = r.depth;
                for (let e = 0, t = n.length; e < t; e += 1) {
                    const t = n[e], i = s[e], a = (l - t.swiperSlideOffset - i / 2) / i,
                        u = "function" == typeof r.modifier ? r.modifier(a) : a * r.modifier;
                    let p = o ? d * u : 0, h = o ? 0 : d * u, f = -c * Math.abs(u), m = r.stretch;
                    "string" == typeof m && -1 !== m.indexOf("%") && (m = parseFloat(r.stretch) / 100 * i);
                    let g = o ? 0 : m * u, v = o ? m * u : 0, y = 1 - (1 - r.scale) * Math.abs(u);
        ...
        te({
            ...
            setTranslate: () => {
                const {slides: e, wrapperEl: i, slidesSizesGrid: n} = t,
                    r = t.params.creativeEffect, {progressMultiplier: o} = r, a = t.params.centeredSlides;
                if (a) {
                ...
                for (let i = 0; i < e.length; i += 1) {
                    ...
                    const u = n.swiperSlideOffset, p = [t.params.cssMode ? -u - t.translate : -u, 0, 0], h = [0, 0, 0];
                    let f = !1;
        ...
        let {swiper: t, extendParams: i, on: n} = e;
        i({cardsEffect: {slideShadows: !0, rotate: !0, perSlideRotate: 2, perSlideOffset: 8}}), te({
            effect: "cards",
            swiper: t,
            on: n,
            setTranslate: () => {
                const {slides: e, activeIndex: i, rtlTranslate: n} = t, s = t.params.cardsEffect, {
                    startTranslate: r,
                    isTouched: o
                } = t.touchEventsData, a = n ? -t.translate : t.translate;
                for (let l = 0; l < e.length; l += 1) {
                    const d = e[l], c = d.progress, u = Math.min(Math.max(c, -4), 4);
