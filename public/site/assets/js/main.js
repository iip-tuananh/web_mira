!function (e) {
    ...
    if (e(window).on("load", (function () {
        ...
        var t = document.querySelector(".scroll-top"), a = document.querySelector(".scroll-top path"),
            n = a.getTotalLength();
        ...
        var s = function () {
            var t = e(window).scrollTop(), s = e(document).height() - e(window).height(), o = n - t * n / s;
    ...
    e("[data-bg-src]").length > 0 && e("[data-bg-src]").each((function () {
        ...
        var t = e(this), a = e(this).data("slider-options"), n = t.find(".slider-prev"), s = t.find(".slider-next"),
            o = t.find(".slider-pagination"), i = a.paginationType ? a.paginationType : "bullets", r = a.autoplay, l = {
                slidesPerView: 1,
                spaceBetween: a.spaceBetween ? a.spaceBetween : 24,
                loop: 0 != a.loop,
                speed: a.speed ? a.speed : 1e3,
                autoplay: r || {delay: 6e3, disableOnInteraction: !1},
                navigation: {nextEl: s.get(0), prevEl: n.get(0)},
                pagination: {
                    el: o.get(0), type: i, clickable: !0, renderBullet: function (e, t) {
        ...
        var t = e(this).data("slider-prev") || e(this).data("slider-next"), a = e(t);
        if (a.length) {
            var n = a[0].swiper;
            n && (e(this).data("slider-prev") ? n.slidePrev() : n.slideNext())
        }
    }));
    var o, i, r, l = ".ajax-contact", c = '[name="email"]', d = e(".form-messages");
    ...
    function u() {
        ...
        (function () {
            ...
            return a
        })() && jQuery.ajax({url: e(l).attr("action"), data: t, type: "POST"}).done((function (t) {
    ...
    e(l).on("submit", (function (e) {
        ...
        e(this).each((function () {
            ...
            n = Math.floor(l.height() / 2), s = l.attr(t), o = l.attr(a), i = h(e(o).css("padding-top")), r = h(e(o).css("padding-bottom")), "top-half" === s ? (e(o).css("padding-bottom", r + n + "px"), l.css("margin-top", "-" + n + "px")) : "bottom-half" === s && (e(o).css("padding-top", i + n + "px"), l.css("margin-bottom", "-" + n + "px"))
        }))
    };
    ...
    })), e(".counter-number").counterUp({delay: 10, time: 1e3}), e.fn.shapeMockup = function () {
        e(this).each((function () {
            var t = e(this), a = t.data("top"), n = t.data("right"), s = t.data("bottom"), o = t.data("left");
            t.css({
                top: a,
                right: n,
                bottom: s,
    ...
    }), {offset: "75%"}), e.fn.countdown = function () {
        e(this).each((function () {
            ...
            var s = setInterval((function () {
                var e = (new Date).getTime(), o = a - e, i = Math.floor(o / 864e5), r = Math.floor(o % 864e5 / 36e5),
                    l = Math.floor(o % 36e5 / 6e4), c = Math.floor(o % 6e4 / 1e3);
                i < 10 && (i = "0" + i), r < 10 && (r = "0" + r), l < 10 && (l = "0" + l), c < 10 && (c = "0" + c), o < 0 ? (clearInterval(s), t.addClass("expired"), t.find(".message").css("display", "block")) : (n(".day").html(i), n(".hour").html(r), n(".minute").html(l), n(".seconds").html(c))
            }), 1e3)
        }))
    ...
    e.fn.inlineSvg = function () {
        ...
        e(this).on("click", (function (t) {
            t.preventDefault();
            var a = e(this).siblings(".qty-input"), n = parseInt(a.val(), 10);
            isNaN(n) || a.val(n + 1)
        }))
